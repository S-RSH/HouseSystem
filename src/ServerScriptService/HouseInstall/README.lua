--[[
    ...
    Documentation: https://developer.roblox.com/resources/developer-modules/social-interactions
    ...
    *   Test out "chat emotes" by typing "Hello, world!" in the chat. In response to that, your character will start waving!
	...
	View full documentation here:
		https://developer.roblox.com/resources/developer-modules/social-interactions
]]
